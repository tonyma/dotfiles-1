  ...
  function()
    ...
    use {
      ...
      config = function()
        ...
        vim.cmd(
          "highlight! GitStatWindow    guibg=" .. vim.g.momiji_colors.green .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatBranch    guibg=" .. vim.g.momiji_colors.green .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatRemote    guibg=" .. vim.g.momiji_colors.green .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatAhead     guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatBehind    guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatSync      guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatUnmerged  guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatStaged    guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatUnstaged  guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
        vim.cmd(
          "highlight! GitStatUntracked guibg=" .. vim.g.momiji_colors.yellow .. " guifg=" .. vim.g.momiji_colors.black
        )
      ...
      },
      {
        ...
        config = function()
          vim.api.nvim_set_keymap(
            "n",
            "<leader>fp",
            '<cmd>lua require("telescope").extensions.gogh.list()<cr>',
            {noremap = true, silent = true}
          )
          vim.api.nvim_set_keymap(
            "n",
          ...
          vim.api.nvim_set_keymap(
            "n",
            "<leader>fpr",
            '<cmd>lua require("telescope").extensions.gogh.repos()<cr>',
            {noremap = true, silent = true}
          )
